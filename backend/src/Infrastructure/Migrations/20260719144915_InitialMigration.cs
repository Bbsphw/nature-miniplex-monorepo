        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Movie_Dates", "[StartDate] <= [EndDate]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowName = table.Column<string>(type: "varchar(5)", unicode: false, maxLength: 5, nullable: false),
                    ColumnName = table.Column<string>(type: "varchar(5)", unicode: false, maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemStatus = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingItems_Showtimes_ShowtimeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItem_Showtime_Seat_Active",
                table: "BookingItems",
                columns: new[] { "ShowtimeId", "SeatId" },
                unique: true,
                filter: "[ItemStatus] = 'Active'");
